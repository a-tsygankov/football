...
export interface SquadAppConfig {
  readonly sync: {
    readonly sourceKind: 'json-snapshot' | 'ea-rosterupdate-json'
...
export const SQUAD_APP_CONFIG: SquadAppConfig = {
  sync: {
    ...
    // Replace with the real normalized snapshot host before production retrievals.
    snapshotUrlTemplate: 'https://YOUR-SNAPSHOT-HOST/{platform}/{version}.json',
